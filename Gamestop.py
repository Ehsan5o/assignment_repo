...
def make_graph(stock_data, revenue_data, stock):
    ...
    x=pd.to_datetime(revenue_data_specific.Date),  # Remove infer_datetime_format argument
...
print("Last five rows of the GameStop stock revenue data:")
print(gme_revenue.tail()[["Date", "Revenue"]])
